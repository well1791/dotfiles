...
abbr -a -- glo 'git log --topo-order --pretty=format:(echo $_git_log_oneline_format) -20'
abbr -a -- gll 'git log --topo-order --pretty=format:(echo $_git_log_fuller_format) -20'
abbr -a -- gld 'git log --topo-order --stat --patch --pretty=format:(echo $_git_log_fuller_format) -20'
abbr -a -- gls 'git log --topo-order --stat --pretty=format:(echo $_git_log_fuller_format) -20'
